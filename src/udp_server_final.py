...
if __name__ == '__main__':
    ...
    stream = [b'\xff' * 46080 for x in range(20)]
    ...
    while True:
        ...
        # data, addr = s.recvfrom(46081)
        # stream[data[0]] = data[1:46081]

        data, addr = s.recvfrom(38402)
        msg = data[1]
        stream[data[0]] = data[2:38402]
        ...
        s.sendto(str(label).encode(), addr)
